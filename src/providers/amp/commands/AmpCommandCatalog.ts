...
export class AmpCommandCatalog implements ProviderCommandCatalog {
  ...
  async saveVaultEntry(_entry: ProviderCommandEntry): Promise<void> {
    throw new Error('Amp runtime commands are not editable from Claudian.');
  }

  async deleteVaultEntry(_entry: ProviderCommandEntry): Promise<void> {
    throw new Error('Amp runtime commands are not deletable from Claudian.');
  }
