...
export class DroidCommandCatalog implements ProviderCommandCatalog {
  ...
  async saveVaultEntry(_entry: ProviderCommandEntry): Promise<void> {
    throw new Error('Droid runtime commands are not editable from Claudian.');
  }

  async deleteVaultEntry(_entry: ProviderCommandEntry): Promise<void> {
    throw new Error('Droid runtime commands are not deletable from Claudian.');
  }
